...
--
-- Table structure for table `bond_pole`
--
...
CREATE TABLE `bond_pole` (
  ...
  PRIMARY KEY (`bond_id`),
  KEY `bond_pole_pole_id_foreign` (`pole_id`),
...
--
-- Dumping data for table `bond_pole`
--

LOCK TABLES `bond_pole` WRITE;
/*!40000 ALTER TABLE `bond_pole` DISABLE KEYS */;
/*!40000 ALTER TABLE `bond_pole` ENABLE KEYS */;
UNLOCK TABLES;
