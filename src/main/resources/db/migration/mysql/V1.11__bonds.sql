...
CREATE TABLE `bonds` (
  ...
  `hiring_process` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `begin` date NOT NULL,
  `terminated_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bonds_employee_id_foreign` (`employee_id`),
  KEY `bonds_role_id_foreign` (`role_id`),
...
-- Dump completed on 2023-08-20  2:01:03
