...
--
-- Table structure for table `impediments`
--
...
CREATE TABLE `impediments` (
  ...
  `description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Vínculo ainda não revisado',
  ...
  PRIMARY KEY (`id`),
  KEY `impediments_bond_id_foreign` (`bond_id`),
  KEY `impediments_reviewer_id_foreign` (`reviewer_id`),
  KEY `impediments_closed_by_id_foreign` (`closed_by_id`),
...
--
-- Dumping data for table `impediments`
--

LOCK TABLES `impediments` WRITE;
/*!40000 ALTER TABLE `impediments` DISABLE KEYS */;
/*!40000 ALTER TABLE `impediments` ENABLE KEYS */;
UNLOCK TABLES;
